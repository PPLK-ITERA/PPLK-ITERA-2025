      ...
      <Table className="relative border">
        <TableHeader>
          <TableRow className="hover:bg-current bg-current">
            ...
            <TableHead className="text-white xl:w-[800px]">Email</TableHead>
            <TableHead className="text-white xl:w-[800px]">Prodi</TableHead>
            <TableHead className="text-white xl:w-[800px]">Pita</TableHead>
