                        ...
                        <div className="w-full px-2.5 py-[96px] md:py-[200px] lg:py-[160px] xl:py-[160px] text-center md:text-start">
                            ...
                            >
                                <span className="font-avigea text-[40px] md:text-[60px] max-w-xl">
                                    UNIT KEGIATAN MAHASISWA (UKM) & KOMUNITAS
                                </span>
                                <br />
                            ...
                            <p
                                ...
                                className="mt-8 text-[18px] md:text-xl leading-4 text-jaffa-100 font-montserrat max-w-xl"
                            >
                                UKM hadir untuk bisa memfasilitasi semua minat &
                                bakat dari seluruh Mahasiswa Institut Teknologi
                                Sumatera.
                            </p>
                        </div>
                    </MaxWidthWrapper>
