  ...
  return (
    <div className="flex flex-col ">
      <div className="max-w-[920px] p-6 mx-auto">
        <div className="bg-flower-pattern rounded-lg">
          <div className="bg-gradient-to-r from-jaffa-700/90 to-jaffa-800/90 font-montserrat relative p-6 rounded-2xl">
            <div className="text-xl font-bold font-greek absolute top-0 -mt-6 -left-2 bg-white text-jaffa-700 py-2 rounded-full border-4 border-[#B9822F] px-14">
              VISI
            </div>

            <p className="mt-6 text-white">“{selectedFakultas.visi}”</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-[920px] p-6 mx-auto">
        <div className="bg-flower-pattern rounded-lg">
          <div className="bg-gradient-to-r from-jaffa-700/90 to-jaffa-800/90 font-montserrat relative p-6 rounded-2xl">
            <div className="text-xl font-greek font-bold absolute top-0 -mt-6 -left-2 bg-white text-jaffa-700 py-2 rounded-full border-4 border-[#B9822F] px-14">
              MISI
            </div>
            <p className="mt-6 space-y-3 text-white">
              {selectedFakultas.misi.map((misi: string, index: number) => (
