...
const OpeningPage = ({ onComplete }) => {
    ...
    const images = [
        ...
        { id: 1, src: pplk2024, alt: 'PPLK 2024', title: 'TEAM SPIRIT', year: 'PPLK 2024', link: 'https://pplk-itera-2024-production-9f53.up.railway.app/informasi/pplk' },
        { id: 2, src: pplk2022, alt: 'PPLK 2022', title: 'LEADERSHIP', year: 'PPLK 2022', link: 'https://pplk-itera-2022-production.up.railway.app/' },
    ];
