...
export default function KegiatanUnggulan({ upt }: { upt?: string }) {
    return (
        <div className="relative bg-pattern-white bg-[#170C0A] z-10">
            ...
            <Carousel
                ...
                className="scroll-smooth z- max-w-[1920px] xl:pl-36 lg:pl-20 md:pl-10 relative w-full pl-5 mx-auto mt-20"
                plugins={[
                    Autoplay({
                        delay: 3000,
                    }),
