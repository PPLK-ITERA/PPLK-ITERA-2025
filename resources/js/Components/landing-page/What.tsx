...
export default function What() {
    return (
        <div className="flex min-h-[70vh] items-center justify-center pt-20 md:pt-32">
            <div className="flex flex-col items-center justify-center text-center">
                ...
                <p className="mt-10 max-w-[826px] font-montserrat text-[16px] font-normal md:text-2xl">
