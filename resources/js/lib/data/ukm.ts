...
import himalaya from "!assets/logoukm/logohimalaya.png";
...
import kukang from "!assets/logoukm/logokukang.png";

import handball from "!assets/logoukm/logohandball.png";
...
import gamahira from "!assets/logoukm/logogamahira.jpg";
...
import lembagapers from "!assets/logoukm/logolembagapers.jpg";
...
export const ukmData = [
          ...
          allprestasi: [
            {
               ...
               deskripsi:"Mimbar Seni: Kegiatan kolaborasi menggabungkan beberapa UKM Kebudayaan dalam menampilkan seni adatnya masing masing di lingkungan ITERA",
            },
            {
               prestasi:kegiatanbatavia2,
               deskripsi:"Penampilan Seni: UKM Batavia sering menampilkan dan mempertunjukkan seni adat betawi, seperti tarian dan palang pintu.",
            },
            {
              prestasi:kegiatanbatavia3,
              deskripsi:"BATUNITY: Sebuah kegiatan dalam merayakan dies natalis batavia tiap tahunnya pada tanggal 19 september.",
           }
        ...
        allprestasi: [
          {
             ...
             deskripsi:"UKM UMPASA ITERA Juara Tari Kreasi Batak Se-Provinsi Lampung tahun 2019",
          },
          {
             prestasi:kegiatanumpasa2,
             deskripsi:"TIM TARI UMPASA ITERA tampil di WISUDA PERIODE KE XII ITERA ",
          },
          {
            prestasi:kegiatanumpasa3,
            deskripsi:"Juara 2 festival kumite+68 kg u21 PUTRI dan juara 3 open kumite +68 U21 PUTRI pada KEJURDA KARATE SHOKAIDO PROVINSI LAMPUNG OPEN TURNAMEN DAN FESTIVAL",
         },
         {
            prestasi:kegiatanumpasa4,
            deskripsi:"UMAPAS DAY yang merupakan program kerja dari Departemen pengembangan dan pelestarian budaya yang bertujuan memperkenalkan UMPASA ITERA ke dalam maupun luar ITERA dengan penampilan musik dan tarian dari 8 etnis Sumatera Utara ",
         }
        ],
...

        {
          ...
          allprestasi: [
            ...
            },
            {
               ...
               deskripsi:"Kunjungan ke panti asuhan, untuk mendukung upaya pendidikan terhadap kebudayaan Sumatera Selatan ",
            },
            {
              prestasi:kegiatansriwijaya3,
              deskripsi:"Sriwijaya Begesah yang bertujuan untuk  menjalin silaturahmi dan keakaraban antar mahasiswa dari berbagai daerah di Sumatera Selatan.",
           },
           {
              prestasi:kegiatansriwijaya4,
              deskripsi:"Ngirup Cuko yang merupakan kegiatan ramah tamah atau Sharing session yang dilakukan dengan Unit Kegiatan Mahasiswa Kebudayaan selain Sriwijaya.",
           }
          ],
              ...
              allprestasi: [
                {
                   ...
                   deskripsi:"Ananda Arkan Khalik (Mahasiswa Prodi Teknologi Industri Pertanian) PON XX Papua 2021 dengan meraih Mendali Emas bersama Tim Softball Lampung",
                }
              ],
        ...
        allprestasi: [
          {
             ...
             deskripsi:" Juara 1 lead putri di pekan olahraga mahasiswa daerah lampung cabang panjat tebing 2023",
          },
          {
             prestasi:defaultimage,
             deskripsi:"Juara harapan 3  kategori W21 dalam kompetisi artala orientering competititon tingkat nasional 2023",
          },
          {
            prestasi:defaultimage,
            deskripsi:"Juara harapan 2 orientering up20 putri dalam kompetisi mahapala orientering and climbing competition 2023 nasional",
         },
         {
            prestasi:defaultimage,
            deskripsi:"Perwakilan Mahasasiswa dalam kegiatan pekan olahraga mahasiswa nasional cabang olahraga panjat tebing di kalimantan 2023",
         }
        ],
...

   {
        ...
        allsosmed: [
          {
              instagram: "https://www.instagram.com/handballtera/",
              youtube: "",
              website: "", 
              tiktok: "",
          }
...

   {
      ...
      allprestasi: [
      {
         ...
         deskripsi:"Telah menerbitkan buku antologi puisi berjudul 'Pembebasan Jiwa yang Rapuh'.",
      }
      ],
...

   {
      ...
      allprestasi: [
      {
         ...
         deskripsi:"Juara 1 ASEAN GAMES UNIVERSITY kategori catur standar beregu putri",
      },
      {
         prestasi:kegiatanicc2,
         deskripsi:"Juara 2 ASEAN GAMES UNIVERSITY kategori catur cepat beregu putri",
      },
      {
         prestasi:kegiatanicc3,
         deskripsi:"Juara 2 ASEAN GAMES UNIVERSITY kategori catur kilat beregu putri",
      },
      {
         prestasi:kegiatanicc4,
         deskripsi:"Juara 1 pekan olahraga nasional mahasiswa (pomnas) kategori catur standar perorangan putri",
      }      
      ],
...

   {
      ...
      },
      {
         ...
         deskripsi:"Mendali perunggu dalam pekan olahraga mahasiswa nasional 2023",
      }      
      ],
...

   {
      ...
      },
      {
         ...
         deskripsi:"Meraih 12 Medali pada ajang Kejuaraaan Karate LA Cup Tahun 2022.",
      },
      {
         prestasi:kegiatankarate3,
         deskripsi:"Kejuaraan Sirkuit Karate Pelajar Shokaido Provinsi Lampung 2023",
      },
      {
         prestasi:kegiatankarate4,
         deskripsi:"Meraih 9 Mendali pada ajang Kejuaraan karate Piala walikota Bandar Lampung 2022",
      }      
      ],
...

   {
      ...
      allprestasi: [
      {
         ...
         deskripsi:"Juara 1 dan 3 PUBG Mobile  Piala Gubernur Esports Pelajar-Mahasiswa 2022",
      },
      {
      ...
      },
      {
         ...
         deskripsi:"PUBG Mobile Jawara Champion S5 Road To PUBG Mobile Campus Champion",
      },
      {
         prestasi:kegiatanteraesport4,
         deskripsi:"Top 16 LENM Mobile Legend Men dan Top 32 LENM Mobile Legend Women",
      }      
      ],
   ...
   
   {
      ...
      },
      {
         ...
         deskripsi:"Medalis emas kategori Putri standar bow pada Kejuaraan panahan PAC 1st Half Archery Youth League di Palembang 2024",
      },
      {
         prestasi:kegiatanarchery3,
         deskripsi:"Juara umum 1 dan 3 pada Perlombaan PELATPROV DAN SELEKSI KEJURNAS YUNIOR SIRKUIT 1 LAMPUNG 2024",
      },
      {
         prestasi:kegiatanarchery4,
         deskripsi:"Juara umum 3 dan 1 pada kejuaraan KAI KADRIVE IV CUP ARCHERY COMPETITION 2023",
      }      
      ],
   ...
   
   {
      ...
      allprestasi: [
      {
         ...
         deskripsi:"Finalis 10 Besar Marine Innovation Festival Indonesia (MARINESIA) Universitas Hasanuddin",
      },
      {
         prestasi:kegiatansaibatin2,
         deskripsi:"Juara Fun Race Etam Ship Competition (ESC) Institut Teknologi Kalimantan ",
      },
      {
         prestasi:kegiatansaibatin3,
         deskripsi:"Finalis 10 Besar Semarak Mahasiswa Perkapalan (SAMPAN) Institut Teknologi Sepuluh Nopember ",
      },
      {
         prestasi:kegiatansaibatin4,
         deskripsi:"Juara 1 Kontes Kapal Cepat Tak Berawak (KKCTBN) Kategori Electrical Boat",
      }      
      ],
   ...
   
   {
      ...
      allprestasi: [
      {
         ...
         deskripsi:"Juara umum 2 putra jambore Nasional mahasiswa bela negara yang diadakan di UPNV Yogyakarta ",
      },
      {
         prestasi:kegiatanpramuka2,
         deskripsi:"Juara umum 3 putri Jambore Nasional mahasiswa Bela Negara yang diadakan di UPNV Yogyakarta ",
      },
      {
         prestasi:kegiatanpramuka3,
         deskripsi:"Juara 1 tali temali putra pada jambore Nasional mahasiswa bela negara di UPNV Yogyakarta ",
      },
      {
         prestasi:kegiatanpramuka4,
         deskripsi:"Juara 2 rapling putri pada jambore Nasional mahasiswa bela negara di UPNV Yogyakarta ",
      }    
      ],
      ...
      allsosmed: [
      {
            ...
            website: "https://linktr.ee/racana.pramuka?fbclid=PAZXh0bgNhZW0CMTEAAaZhr7tYn70HcYz1qxUexSJYAUD6glDilIx6OPpKW3qaqAiRYgqPaeQERNY_aem_uGfC4h34AmCwzhcmaBOeTA", 
            tiktok: "",
      }
      ]}, 
   
   {
      ...
      allprestasi: [
      {
         ...
         deskripsi:"Juara 1 anisong competition dalam event Tacco Fest di taman budaya Lampung ",
      },
      {
         prestasi:kegiatanakai2,
         deskripsi:"Juara 3 cosplay Competition dalam event Ibento Kanri Comuncation yang di selenggarakan oleh Universitas Bandar Lampung di taman Budaya provinsi Lampung",
      },
      {
         prestasi:kegiatanakai3,
         deskripsi:"Juara 3 Digital Art dalam event Ibento Kanri Comuncation yang di selenggarakan oleh Universitas Bandar Lampung di taman Budaya provinsi Lampung",
      },
      {
         prestasi:kegiatanakai4,
         deskripsi:"Juara Favorit 2 dalam event Krakatau Festival yang di selenggarakan oleh Dinas Pariwisatadan kreatif di lapangan Korpri",
      }    
      ],
   ...
   
   {
      ...
      },
      {
         ...
         deskripsi:"Pemateri pelatihan pertolongan pertama dan atau bantuan hidup dasar",
      },
      {
   ...
   
   {
      ...
      allprestasi: [
      {
         ...
         deskripsi:"Juara 1 Lomba Essai Kanal Akbar Suara Ekonomi VIII LPM Suara Ekonomi Universitas Pancasila Tahun 2023",
      },
      {
         prestasi:kegiatanlembagapers2,
         deskripsi:"Juara 2 Lomba Fotografi Jurnalistik Kanal Akbar Suara Ekonomi VIII LPM Suara Ekonomi Universitas Pancasila Tahun 2023",
      },
      {
         prestasi:kegiatanlembagapers3,
         deskripsi:"Juara 3 Lomba Fotografi Jurnalistik Kanal Akbar Suara Ekonomi VIII LPM Suara Ekonomi Universitas Pancasila Tahun 2023",
      }    
      ],
      ...
      
   {
      ...
      allprestasi: [
      {
         ...
         deskripsi:"Spotify KMK merupakan suatu media musik yang dibuat KMK untuk menyalurkankan bakat suara dari anak KMK sekaligus mengenalkan KMK ITERA",
      },
      {
         prestasi:kegiatankmk2,
         deskripsi:"KMK OUR DAY merupakan kegiatan yang diadakan KMK ITERA, yang bertujuan untuk menghimpun UKM katolik yang ada di Lampung sekaligus mengenalkan KMK itera ke  UKM katolik yang ada di Lampung",
      }  
      ],
...

   {
      ...
      allprestasi: [
      {
         ...
         deskripsi:"meraih medali perak pada kategori Mix Youth Choir dan kategori Gospel Spiritual di ajang Bali International Choir (BICF) 7 tahun 2018",
      } 
      ],
   ...
   {   
      ...
      },
      {
         ...
         deskripsi:"Musabaqah Tilawatil Qur'an Mahasiswa Nasional (MTQ-MN) Universitas Brawijaya",
      },
      {
         prestasi:kegiatansenireligi3,
         deskripsi:"Juara 1 Lomba MTQ Remaja Tingkat Kabupaten TulangBawang,28 November 2019 MTQ Remaja (Putri)Yanti Sari",
      },
      {
         prestasi:kegiatansenireligi4,
         deskripsi:"Juara 1 Tartil Qur’anOlimpiade Mahasiswa Muslim ITERA 2021 17 Mei 2021Gusri Wahyuni	",
      } 
      ],
   ...
   {   
      ...
      allprestasi: [
      {
         ...
         deskripsi:"Juara 1 dan 3 dalam kejuaraan sosialisasi  dan exhibition olahraga petanque antar universitas se provinsi lampung",
      },
      {
         prestasi:kegiatanpetanque2,
         deskripsi:"Mengirimkan 4 delegasi untuk Pra-PON cabor Petanque di Bali ",
      } 
      ],
