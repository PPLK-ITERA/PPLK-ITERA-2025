...
export default function Page() {
    return (
        <div>
            ...
            <div className="h-screen relative min-h-[40vh] bg-mobile-hero-background bg-cover bg-center md:min-h-screen md:bg-tablet-hero-background lg:bg-desktop-hero-background flex items-center justify-center">
