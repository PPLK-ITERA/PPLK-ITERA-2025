    ...
    const renderTableRows = () => {
        return data.map((item) => (
            <TableRow key={item.id}>
                <TableCell width={200} className="p-0 w-[200px]">
                    <img
                        className="w-[140px] h-[112px]"
                        src={item.user.photo_profile_url ?? ""}
                        alt="Foto Maba"
                    />
                </TableCell>
        ...
        <div className="w-full">
            <div className="flex justify-between mb-4">
                <div>
                    ...
                    <select
                        ...
                        className="ps-2 w-16 p-1 mx-2 border"
                    >
            ...
            <div className="mt-4">
                <span>
                    ...
                    to {Math.min(currentPage * perPage, total)} of {total}{" "}
                    entries
                </span>
            </div>
        </div>
