...
const breadcrumbItems = [
  ...
  { title: "Admin Tesla", link: "/dashboard/tesla" },
];
...
const TeslaAdminPage: React.FC<{ auth: any }> = ({ auth }) => {
    ...
    return (
        <DashboardLayout user={auth?.user}>
            <div className="min-h-screen w-full py-8 px-2 md:px-8">
                <div className="max-w-6xl mx-auto">
                    <Breadcrumbs items={breadcrumbItems} />
                    <h2 className="text-3xl font-bold tracking-tight mb-8 text-white drop-shadow">Tesla</h2>
                    <div className="space-y-8">
                        {/* --- Day Edit Section --- */}
                        <Card className="p-4 md:p-6 bg-white/90 shadow-lg rounded-xl w-full max-w-full">
