      ...
      <Table className="relative border">
        <TableHeader>
          <TableRow className="hover:bg-current bg-current">
            ...
            <TableHead className="max-w-lg text-white">Jawaban</TableHead>
          ...
          {dataFAQS.map((faq, index) => (
            <TableRow key={index}>
              ...
              <TableCell className="max-w-[200px]">
                <p className="line-clamp-1">{faq.teks_pertanyaan}</p>
              </TableCell>
              ...
              <TableCell className="flex gap-2 text-right">
                <Dialog>
                  <DialogTrigger asChild>
                    <Button className="gap-2" onClick={() => changeData(faq)}>
                      Edit
                    </Button>
                  </DialogTrigger>
                    ...
                    <div className="grid gap-4 py-4">
                      <div className="flex flex-col">
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setData("teks_pertanyaan", e.target.value)
                          }
                      ...
                      <div className="flex flex-col">
                        ...
                        <Textarea
                          ...
                          onChange={(e) =>
                            setData("teks_jawaban", e.target.value)
                          }
                ...
                <AlertDialog>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        Pertanyaan dan jawaban FAQ akan dihapus permanen dan
                        tidak dapat dikembalikan.
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
                      <AlertDialogCancel>Cancel</AlertDialogCancel>
                      <AlertDialogAction onClick={() => deleteFAQ(faq)}>
                        Continue
                      </AlertDialogAction>
                    </AlertDialogFooter>
                  </AlertDialogContent>
