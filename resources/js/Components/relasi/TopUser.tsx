    ...
    return (
        ...
        >
            ...
            {user && (
                <div className="md:w-24 md:h-24 relative w-20 h-20 rounded-full shadow-lg">
                    ...
                    <img
                        ...
                        alt={user.name}
                        className="z-0 bg-gray-400 rounded-full object-cover w-full h-full"
                    />
                </div>
            )}
            ...
            <p className="bg-gray-400/50 md:px-2 px-0 text-sm rounded-full">
                {user && <span className="font-bold">{user.followers_count} </span>}
                Followers
            </p>

            {
                {
                    1: (
                        <Podium color="gold" maxHeightPx={podiumHeight} className="">
                            <p className="md:text-5xl text-3xl font-bold">{rank}</p>
                        </Podium>
                    ),
                    2: (
                        <Podium color="silver" maxHeightPx={podiumHeight} className="">
                            <p className="md:text-5xl text-3xl font-bold">{rank}</p>
                        </Podium>
                    ),
                    3: (
                        <Podium color="bronze" maxHeightPx={podiumHeight} className="">
                            <p className="md:text-5xl text-3xl font-bold">{rank}</p>
                        </Podium>
                    ),
                }[rank]
