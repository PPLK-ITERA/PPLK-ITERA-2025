...
const Page: React.FC = () => {
    ...
    return (
        <div className="relative flex h-screen w-full flex-col text-center">
            <div>
                <h2 className="mt-[174px] font-avigea text-[39px] text-jaffa-900">
                ...
                <div className="mx-[142px] mt-[56px]">
