        ...
        <div className="flex gap-1 p-2">
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                <AlertDialogTitle>
                  Apakah Anda yakin ingin meng-Absen {data.user.name}
                </AlertDialogTitle>
                <AlertDialogDescription>
                  Aksi ini akan mengubah status maba menjadi hadir.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
          ...
          {data.user.status !== "Izin" ? (
            <Dialog>
              ...
              <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                  <DialogTitle>Ingin Set Izin {data.user.name} ?</DialogTitle>
                  <DialogDescription>
                    Isi bagian catatan dan aksi ini akan mengubah status maba
                    menjadi izin
                  </DialogDescription>
                </DialogHeader>
                ...
                <div className="grid gap-4 py-4">
                  <div className="flex flex-col">
                    ...
                    <Textarea
                      ...
                      onChange={(e) =>
                        setDataFormAbsensi("keterangan", e.target.value)
                      }
