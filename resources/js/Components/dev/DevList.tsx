  ...
  function shuffleDisplay() {
    ...
    for (let i = 0; i < 5; i++) {
      setTimeout(() => {
        ...
        setDisplayName(
          i == 4 ? currentDev.name : generateRandomText(currentDev.name),
        );
        setDisplayRole(
          i == 4 ? currentDev.role : generateRandomText(currentDev.role),
        );
        setDisplayInstagram(
          i == 4
        ...
        setDisplayQuote(
          i == 4 ? currentDev.quote : generateRandomText(currentDev.quote),
        );
